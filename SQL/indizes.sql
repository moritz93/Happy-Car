...
-- Index Aufträge
CREATE INDEX IDX_Aufträge ON Aufträge (AID, Status) WHERE Status = 'ARCHIVIERT';
...
-- Index liefert
CREATE INDEX IDX_liefert ON liefert (KFZ_ID, MID, AID, Status) WHERE Status = 'ARCHIVIERT';
